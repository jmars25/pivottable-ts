...
(function() {
  ...
  PivotData = (function() {
    ...
    PivotData2.forEachRecord = function(input, derivedAttributes, f) {
      ...
      if (typeof input === "function") {
        ...
        const headers = Array.prototype.slice.call(input.querySelectorAll("thead > tr > th")).map(function(th) {
    ...
    PivotData2.prototype.processRecord = function(recordOrIndex, columnarInput) {
      ...
      function readColumnarValue(columnarInput2, attr, i) {
        var _a2;
        const col = columnarInput2.columns[attr];
        if (col == null) return "null";
        const dict = (_a2 = columnarInput2.dicts) == null ? void 0 : _a2[attr];
      ...
      if (columnarInput != null) {
        ...
        for (const attr of this.valAttrs) {
          ...
          const dict = (_a = columnarInput.dicts) == null ? void 0 : _a[attr];
            ...
            if (done) {
              ...
              for (var j = 0; j < finalLines.length; j++) {
                if (finalLines[j].trim().length > 0) {
                  try {
                    self.push(JSON.parse(finalLines[j]));
                  } catch (e) {
                  }
                }
              }
  ...
  pivotTableRenderer = function(pivotData, opts) {
    ...
    const getClickHandler = table.clickCallback ? function(value, rowValues, colValues) {
      const filters = {};
      colAttrs.forEach(function(attr, i) {
        if (colValues[i] != null) filters[attr] = colValues[i];
      });
      rowAttrs.forEach(function(attr, i) {
        if (rowValues[i] != null) filters[attr] = rowValues[i];
      });
      return function(e) {
        return table.clickCallback(e, value, filters, pivotData);
      };
    } : null;
